...
format:
  revealjs:
    transition: slide
    footer: "Automating Support Messages with LLMs for AUD Intervention"
    slide-number: true
    code-fold: false
    theme: decoration
---
...
::: info-box
-   Collaboration with Curtin Lab on Smart A-CHESS project
-   Focus on automating personalized engagement messages
-   Using Azure OpenAI API for message generation
:::

::: notes
This presentation focuses on my contribution to the Curtin Lab's research on smart digital therapeutics for alcohol use disorder. Specifically, I've developed an R interface that connects to the Azure OpenAI API to automate the generation of personalized support messages.

These messages, and therefore the message generation process, represent a crucial component of this study for two key reasons. Firstly, these messages deliver the personalized risk information that forms the foundation of the experimental design, and secondly, this automation provides a practical, cost-effective approach to scaling this intervention for broader implementation, especially outside of research settings.
:::

## Understanding *A-CHESS* & Research Context {.section-slide}
...
-   information about lapse probability including changes in that probability over time

-   important risk factors identified by the model,

-   and specific module recommendations tailored to address those risk factors.
